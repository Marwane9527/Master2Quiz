...
<head>
    ...
    <title>Administrateur | Quiz</title>
...
<body>
    <nav class="navbar bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="../panel.php">Administrateur | Quiz</a>
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                ...
                $sql = "SELECT id, title, description, user_id FROM quizzes";
                ...
                if (count($result) > 0) {
                    ...
                    <tr>
                        ...
                        <td id="deleteQuiz"><a href="deleteQuiz.php?id=<?= $row['id'] ?>"><button style="background-color: red;"
